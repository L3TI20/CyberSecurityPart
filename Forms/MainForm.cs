...
{
    /// <summary>
    /// Part 2 GUI — modern two-panel layout.
    /// Left: sidebar with logo, user info card, and topic shortcut buttons.
    /// Right: chat area with rounded bubbles and a clean input bar.
    /// Purple/indigo theme — completely different from Part 1.
    /// </summary>
    public class MainForm : Form
    {
        ...
        // ── Colour palette — purple/indigo, nothing like Part 1 ───────────────
        ...
        /// <summary>Adds a user message bubble — right-aligned, purple background.</summary>
        ...
        /// <summary>Adds a bot message bubble — left-aligned, dark background, purple left border.</summary>
